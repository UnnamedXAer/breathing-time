...
const instructions: LanguageMessages["instructions"] = {
  ...
  paragraphs: [
    ...
    [
      "Wstrzymaj oddech - po ostatnim wydechu weź dodatkowy głęboki oddech - wypełnij płuca w pełni i pozwól powietrzu opuścić płuca - przestań oddychać. Wstrzymuj oddech aż poczujesz potrzebę nabrania powietrza.",
    ...
    [
      "Regeneracja - gdy poczujesz potrzebę wzięcia oddechu wciąg powietrze aby w pełni wypełniło płuca i wstrzymaj oddech na 15 sekund.",
